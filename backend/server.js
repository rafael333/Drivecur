...
// Rota GET na raiz para verificar se o servidor está funcionando
app.get('/', (req, res) => {
  res.json({
    status: 'online',
    message: 'Backend Drivecur API está rodando!',
    endpoints: {
      token: 'POST /api/google/oauth/token',
      refresh: 'POST /api/google/oauth/refresh'
    }
  });
});
